...
import { MoreHorizontal, UserX, UserCheck, Trash2, Edit } from 'lucide-react';
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuItem,
...
import { useDeactivateUser, useReactivateUser, useDeleteInvite } from '../hooks/useUsersQuery';
